...
export const enUS: Record<string, string> = {
  ...
  'home.openServiceUrl': 'Open service URL',
  ...
  'status.maintenanceDowntimeLabel': 'Planned maintenance downtime: {duration}',
  'status.maintenanceExtraLabel': 'Plus maintenance downtime: {duration}',
  ...
  'service.heatmapHint': 'Average response time by date and hour; the redder the cell, the slower. When the whole window is fast (average below 200ms) every cell stays green. A dot marks an hour with failed probes: red for real failures, blue for planned maintenance windows.',
  'service.heatmapHintNarrow': 'On mobile each day is aggregated into 8 buckets of 3 hours (weighted average of successful samples). Colours and dots mean the same as on desktop.',
  ...
  'service.heatmapAllFailedMaintenance': 'All failed during maintenance',
  'service.heatmapMaintenance': 'Under maintenance',
  ...
  'chart.maintenanceFailure': 'Failure (maintenance)',
