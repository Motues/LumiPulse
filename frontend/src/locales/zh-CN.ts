...
export const zhCN: Record<string, string> = {
  ...
  'status.maintenanceDowntimeLabel': '维护期间停机：{duration}',
  'status.maintenanceExtraLabel': '维护期间另有：{duration}',
  'status.daysAgo': '{n} 天前',
  'status.today': '今天',
  ...
  'service.heatmapHint': '按「日期 × 小时」展示平均响应时间，颜色越红越慢；整体很快（平均低于 200ms）时一律显示为绿色。右上角圆点表示该小时出现过失败探测：红色为真实故障，蓝色为维护窗口内的计划内停机。',
  'service.heatmapHintNarrow': '移动端把一天聚合成 8 个 3 小时格子（每格取该时段成功样本的加权平均）。颜色与圆点含义同宽屏一致。',
  ...
  'service.heatmapAllFailedMaintenance': '维护期间全部失败',
  'service.heatmapMaintenance': '维护中',
  ...
  'chart.normal': '正常',
  'chart.failure': '故障',
  'chart.maintenanceFailure': '维护中故障',
  'chart.noData': '无数据',
